...
CREATE TABLE `apply_plate` (
  ...
  `info` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '申请的理由',
  `plate_id` int(11) NOT NULL DEFAULT '0' COMMENT '申请的板块',
  `state` tinyint(3) DEFAULT '1' COMMENT '1 有效 0无效',
  `gmt_create` datetime NOT NULL COMMENT '创建时间',
  `gmt_modify` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='版主申请表';
...
CREATE TABLE `askhelp` (
  ...
  `message` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '求问信息',
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  `state` tinyint(3) NOT NULL DEFAULT '1' COMMENT '状态：1 有效 2无效',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='求问表';
...
CREATE TABLE `chat_record` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='讨论组聊天记录表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='喜欢的文章表';
...
CREATE TABLE `follow` (
  ...
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='关注人表';
...
CREATE TABLE `permission` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='权限表';
...
CREATE TABLE `plater` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `plate_name` varchar(10) DEFAULT NULL COMMENT '板块名称',
  ...
  `user_modify` int(11) DEFAULT NULL COMMENT '修改着id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='板块表';
...
CREATE TABLE `post` (
  ...
  `info` varchar(10000) NOT NULL DEFAULT '' COMMENT '帖子内容',
  ...
  `ban_reason` varchar(255) DEFAULT NULL COMMENT '被封禁理由',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='讨论帖子表';
...
CREATE TABLE `private_letter` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='私信表';

-- ----------------------------
-- Records of private_letter
-- ----------------------------
INSERT INTO `private_letter` VALUES ('1', '4', '1', '啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊', '', '1', '1', '2019-03-24 16:05:34', '2019-03-31 22:16:39', '1', '0');
INSERT INTO `private_letter` VALUES ('2', '1', '12', '你就是个篮子', '', '0', '12', '2019-03-31 22:38:21', '2019-03-31 22:38:57', '1', '1');
INSERT INTO `private_letter` VALUES ('3', '1', '12', '来成都看我干不干你就完事了', '', '0', '12', '2019-03-31 22:38:43', '2019-03-31 22:39:00', '1', '1');
INSERT INTO `private_letter` VALUES ('4', '12', '1', '日嫩娘', '', '0', '1', '2019-03-31 22:39:18', '2019-03-31 22:56:51', '1', '0');
INSERT INTO `private_letter` VALUES ('5', '1', '12', '你好', '', '1', '1', '2019-04-10 13:05:47', '2019-04-10 13:05:47', '1', '1');
...
CREATE TABLE `reply` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `reply_info` varchar(120) NOT NULL COMMENT '回复信息',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='回复表';
...
CREATE TABLE `resource` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `file_url` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '资源url',
  `file_size` int(11) NOT NULL COMMENT '资源大小',
  `file_name` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '资源名称',
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  `gmt_modify` datetime DEFAULT NULL COMMENT '修改时间',
  `user_create` int(11) DEFAULT NULL COMMENT '创建者id',
  `user_modify` int(11) DEFAULT NULL COMMENT '修改者id',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='上传的资源表';
...
CREATE TABLE `team` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `team_name` varchar(20) NOT NULL COMMENT '小组名称',
  ...
  `gmt_modify` datetime DEFAULT NULL COMMENT '修改时间',
  `user_modify` int(11) DEFAULT NULL COMMENT '修改者id',
  `memo` varchar(255) NOT NULL COMMENT '小组说明',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='讨论组表';
...
CREATE TABLE `team_invite` (
  ...
  `gmt_modify` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '修改时间',
...
CREATE TABLE `total_station_information` (
  ...
  `user_name` varchar(30) NOT NULL COMMENT '发出消息者名称',
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  `gmt_modify` datetime DEFAULT NULL COMMENT '修改时间',
  ...
  `state` tinyint(1) DEFAULT '1' COMMENT '状态，1 有效 2 无效',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='全站信息表';
...
CREATE TABLE `user` (
  ...
  `psw` varchar(100) NOT NULL COMMENT '密码',
  ...
  `signa_ture` varchar(255) DEFAULT NULL COMMENT '个性签名',
  ...
  `gmt_modify` datetime DEFAULT NULL COMMENT '修改时间',
  `user_modify` int(11) DEFAULT NULL COMMENT '修改者id',
  `ban_reason` varchar(255) DEFAULT NULL COMMENT '封禁理由',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', '970009721@qq.com', '123', '1000', '970009721@qq.com', '970009721@qq.com1554450109233.jpg', '3', '11', '', '22', '1', '2019-03-04 13:05:45', '2019-04-05 15:41:49', '1', null);
INSERT INTO `user` VALUES ('3', '308045454@qq.com', 'bde525986a233c8210fcf9223df865a5', '0', '308045454@qq.com', '308045454@qq.com1554450170779.jpg', '2', '冲冲冲冲冲', '', '22', '1', '2019-03-12 11:10:27', '2019-04-05 15:42:51', '3', null);
INSERT INTO `user` VALUES ('4', '123', '123', '0', '123', 'default.jpg', '2', '冲冲冲冲冲', '', '2', '1', '2019-03-14 11:27:33', '2019-04-10 13:54:36', '1', '长得好丑');
INSERT INTO `user` VALUES ('5', '970009721@qq.co', '9e3480e2ec2c0cfaba01bda6aac6a386', '0', '970009721@qq.co', 'default.jpg', '1', '冲冲冲冲冲', '', '2', '1', '2019-03-14 16:22:34', '2019-03-14 16:22:36', null, null);
INSERT INTO `user` VALUES ('6', '小刘', '123', '0', 'test1@qq.com', 'default.jpg', '1', '冲冲冲冲冲', '', '2', '1', '2019-03-15 13:18:08', '2019-03-15 13:18:11', null, null);
INSERT INTO `user` VALUES ('7', '小张', '123', '0', 'test2qq.com', 'default.jpg', '1', '冲冲冲冲冲', '', '2', '1', '2019-03-15 13:18:31', '2019-03-15 13:18:34', null, null);
INSERT INTO `user` VALUES ('8', '老王', '123', '0', 'test3qq.com', 'default.jpg', '1', '冲冲冲冲冲', '', '2', '1', '2019-03-15 13:18:50', '2019-03-15 13:18:53', null, null);
INSERT INTO `user` VALUES ('9', '小李', '123', '0', 'test3qq.com', 'default.jpg', '1', '冲冲冲冲冲', '', '2', '1', '2019-03-15 13:19:08', '2019-03-15 13:19:10', null, null);
INSERT INTO `user` VALUES ('10', '小陈', '123', '0', 'test5qq.com', 'default.jpg', '1', '冲冲冲冲冲', '', '2', '1', '2019-03-15 13:58:49', '2019-03-15 13:58:49', null, null);
INSERT INTO `user` VALUES ('11', '小杨', '123', '0', 'qqqq.com', 'default.jpg', '1', '冲冲冲冲冲', '', '2', '1', '2019-03-15 13:59:15', '2019-03-15 13:59:18', null, null);
INSERT INTO `user` VALUES ('12', '小猪尼若', '123', '0', 'niruo', 'default.jpg', '1', '冲冲冲冲冲', '', '2', '1', '2019-03-15 13:59:33', '2019-03-15 13:59:33', null, null);
INSERT INTO `user` VALUES ('13', '小猪佩奇', '123', '200', 'peiqi', 'default.jpg', '1', '冲冲冲冲冲', '', '2', '1', '2019-03-15 13:59:48', '2019-03-15 13:59:50', null, null);
INSERT INTO `user` VALUES ('14', '小黄', '123', '0', 'oiqwhe1', 'default.jpg', '1', null, '', '2', '1', '2019-03-15 14:00:02', '2019-03-15 14:00:03', null, null);
...
CREATE TABLE `user_ban` (
  ...
  `user_modify` int(11) DEFAULT NULL COMMENT '修改者id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户封禁表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='用户小组关联表';
